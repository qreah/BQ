...
public class BQ2 {
	...
	public static void ActualizarBDGratuito(String Fecha) throws IOException, TimeoutException, InterruptedException {
		...
		try {
			...
			String Estado = BQ2.BorrarTabla(Project, Dataset, Tabla1);
			...
			BQ2.EjecutarConsultaNuevaTabla(SQL1, Project, Dataset, Tabla1);
		...
		try {
			...
			String Estado = BQ2.BorrarTabla(Project, Dataset, Tabla2);
			...
			BQ2.EjecutarConsultaNuevaTabla(SQL2, Project, Dataset, Tabla2);
		...
		try {
			...
			String Estado = BQ2.BorrarTabla(Project, Dataset, Tabla);
			...
			BQ2.EjecutarConsultaNuevaTabla(SQLFinal, Project, Dataset, Tabla);
			...
			try {
				...
				String Estado = BQ2.BorrarTabla("mov-prod5", "GenerationAlias", Tabla);
				...
				BQ2.EjecutarConsultaNuevaTabla(SQL_T01_GratuitoYPagado, Project, Dataset, Tabla);
	...
	public static void ActualizarBDPerso(String Fecha) throws IOException, TimeoutException, InterruptedException {
		...
		BQ2.BorrarTabla(Project, Dataset, TablaCDR);
		String SQLCDR = SQL(TablaCDR);
		System.out.println("SQL Perso: " + SQLCDR);
		BQ2.EjecutarConsultaNuevaTabla(SQLCDR, Project, Dataset, TablaCDR);
		
		String Tabla900 = "P01_SQLPerso900";
		BQ2.BorrarTabla(Project, Dataset, Tabla900);
		String SQL900 = SQL(Tabla900);
		//System.out.println("SQL Perso: " + SQL900);
		BQ2.EjecutarConsultaNuevaTabla(SQL900, Project, Dataset, Tabla900);
		
		String TablaC2C = "P01_SQLPersoC2C";
		BQ2.BorrarTabla(Project, Dataset, TablaC2C);
		String SQLC2C = SQL(TablaC2C); 
		BQ2.EjecutarConsultaNuevaTabla(SQLC2C, Project, Dataset, TablaC2C);
		
		String TablaPersoCDR = "P03_PersoyCDR";
		BQ2.BorrarTabla(Project, Dataset, TablaPersoCDR);
		String SQLPersoCDR = SQL(TablaPersoCDR); 
		BQ2.EjecutarConsultaNuevaTabla(SQLPersoCDR, Project, Dataset, TablaPersoCDR);
		
		String TablaCDRyGA = "P06_CDR_GA";
		BQ2.BorrarTabla(Project, Dataset, TablaCDRyGA);
		String SQLCDRyGA = SQL(TablaCDRyGA); 
		BQ2.EjecutarConsultaNuevaTabla(SQLCDRyGA, Project, Dataset, TablaCDRyGA);
		...
		*/
		...
		BQ2.AjustarImpresiones();
		BQ2.PonerRegistrosACero("GenerationAlias", "P06_CDR_GA", "Leads");
		BQ2.GestionarIncidencia(Fecha);
	...
	public static void GestionarIncidencia(String Fecha) throws TimeoutException, InterruptedException, IOException {
		...
		BQ2.BorrarTabla(Project, Dataset, TablaIncidencia);
		String SQLIncidencia = SQL(TablaIncidencia); 
		BQ2.EjecutarConsultaNuevaTabla(SQLIncidencia, Project, Dataset, TablaIncidencia);
	...
	public static void ActualizarBDPerso2() throws InterruptedException, TimeoutException, IOException {
		...
		BQ2.BorrarTabla(Dataset, TablaPersoFinal);
		...
		InputStream in = BQ2.class.getResourceAsStream("/SQLPersoC2C");
		String SQLPersoC2C = CharStreams.toString(new InputStreamReader(
			      in, Charsets.UTF_8));
		BQ2.EjecutarConsultaNuevaTabla(SQLPersoC2C, Dataset, TablaPersoC2C);
		String TablaPerso900 = "Perso900";
		in = BQ2.class.getResourceAsStream("/SQLPerso900");
		String SQLPerso900 = CharStreams.toString(new InputStreamReader(
			      in, Charsets.UTF_8));
		BQ2.EjecutarConsultaNuevaTabla(SQLPerso900, Dataset, TablaPerso900);
		
		// Unificar tablas
		in = BQ2.class.getResourceAsStream("/SQLPersoUnion");
		String SQLPersoUnion = CharStreams.toString(new InputStreamReader(
			      in, Charsets.UTF_8));
		BQ2.EjecutarConsultaNuevaTabla(SQLPersoUnion, Dataset, TablaPerso);
		BQ2.BorrarTabla(Dataset, TablaPersoC2C);
		BQ2.BorrarTabla(Dataset, TablaPerso900);
		
		
		// BD Final donde se cruza la tabla Perso con la del CDR
		in = BQ2.class.getResourceAsStream("/SQLPersoFinal");
		String SQLPersoFinal = CharStreams.toString(new InputStreamReader(
			      in, Charsets.UTF_8));
		BQ2.EjecutarConsultaNuevaTabla(SQLPersoFinal, Dataset, TablaPersoFinal);
		...
		BQ2.BorrarTabla(Dataset, TablaPerso);
	...
	while (i < ListaAliasError.size()) {
		...
		String Label = BQ2.SacarDato(SQLSELECT);
	...
	public static void ActualizarBDGeneracion() throws IOException {
		InputStream in = BQ2.class.getResourceAsStream("/SQLGeneracion");
		String SQL = CharStreams.toString(new InputStreamReader(
			      in, Charsets.UTF_8));
		try {
			String Tabla = "Generacion";
			String Estado = BQ2.BorrarTabla("GenerationAlias", Tabla);
			if (Estado.equals("OK")) {
				System.out.println("Hecho. OK. La Tabla " + Tabla + " se ha borrado correctamente");
			} else {
				System.out.println("La Tabla " + Tabla + " no existía");
			}
			BQ2.EjecutarConsultaNuevaTabla(SQL, "GenerationAlias", Tabla);
